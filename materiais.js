document.addEventListener("DOMContentLoaded", () => {
    ...
    const produtosData = [
        { id: "escola-area", titulo: "Álbum de área - escola", categoria: "Área", descricao: "Área", preco: "R$ 4,50", imagem: "imagens/produtos/produto1.jpg", amostra: "imagens/amostra/escola.png" },
        { id: "decomposicao", titulo: "Decomposição em fatores primos - Stitch", categoria: "Decomposição em fatores primos", descricao: "Decomposição em fatores primos", preco: "R$ 4,50", imagem: "imagens/produtos/produto2.jpg", amostra: "imagens/amostras/decomposicao.png" },
        ...
        { id: "receitas-despesas", titulo: "Receitas e Despesa", categoria: "Educação Financeira", descricao: "Educação Financeira", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/receitas-despesas.png" },
        ...
        { id: "expressoes-minions", titulo: "Minions", categoria: "Expressões numéricas", descricao: "Expressões numéricas", preco: "R$ 6,00", imagem: "imagens/produtos/produto3.jpg", amostra: "imagens/amostras/expressoes-minions.png" },
        ...
        { id: "identificacao-fracao", titulo: "Identificação de fração", categoria: "Fração", descricao: "Fração", preco: "R$ 3,50", imagem: "imagens/produtos/produto5.jpg", amostra: "imagens/amostras/identificacao-fracao.png" },
        { id: "bob-esponja", titulo: "Adição e subtração de fração - Bob Esponja", categoria: "Fração", descricao: "Fração", preco: "R$ 4,00", imagem: "imagens/produtos/produto6.jpg", amostra: "imagens/amostras/bob-esponja.png" },
        ...
        { id: "halloween", titulo: "Halloween", categoria: "Números decimais", descricao: "Números decimais", preco: "R$ 4,50", imagem: "imagens/produtos/produto1.jpg", amostra: "imagens/amostras/halloween.png" },
        { id: "ferias", titulo: "Férias", categoria: "Números decimais", descricao: "Números decimais", preco: "R$ 4,50", imagem: "imagens/produtos/produto2.jpg", amostra: "imagens/amostras/ferias" },
        { id: "gatinho", titulo: "Gatinho", categoria: "Números decimais", descricao: "Números decimais", preco: "R$ 6,00", imagem: "imagens/produtos/produto3.jpg", amostra: "imagens/amostras/gatinho.png" },
        { id: "natal", titulo: "Natal", categoria: "Números decimais", descricao: "Números decimais", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/natal.png" },
        { id: "egito", titulo: "Sistema de numeração egipcio", categoria: "Números egipcios", descricao: "Números egipcios", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/egito.png" },
        { id: "bbb-4operacoes", titulo: "Quatro operações - bbb", categoria: "Números inteiros", descricao: "Números inteiros", preco: "R$ 4,50", imagem: "imagens/produtos/produto1.jpg", amostra: "imagens/amostras/bbb-4operacoes.png" },
        { id: "bbb-adicao-subtracao", titulo: "Adição e subtração - bbb", categoria: "Números inteiros", descricao: "Números inteiros", preco: "R$ 4,50", imagem: "imagens/produtos/produto2.jpg", amostra: "imagens/amostras/bbb-adicao-subtracao" },
        { id: "bbb-multiplicacao-divisao", titulo: "Multiplicação e divisão - bbb", categoria: "Números inteiros", descricao: "Números inteiros", preco: "R$ 6,00", imagem: "imagens/produtos/produto3.jpg", amostra: "imagens/amostras/bbb-multiplicacao-divisao.png" },
        { id: "carnaval-potenciacao", titulo: "Potenciação - carnaval", categoria: "Potenciação - carnaval", descricao: "Números inteiros", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/carnaval-potenciacao.png" },
        ...
        { id: "bbb-4operacoes-naturais", titulo: "Quatro operações (naturais) - bbb", categoria: "Números naturais", descricao: "Números naturais", preco: "R$ 4,50", imagem: "imagens/produtos/produto1.jpg", amostra: "imagens/amostras/bbb-4operacoes-naturais.png" },
        { id: "carnaval-multiplicacao", titulo: "Multiplicação - carnaval", categoria: "Números naturais", descricao: "Números naturais", preco: "R$ 4,50", imagem: "imagens/produtos/produto2.jpg", amostra: "imagens/amostras/carnaval-multiplicacao" },
        ...
        { id: "volta-4operacoes", titulo: "Quatro operações - volta às aulas", categoria: "Números naturais", descricao: "Números naturais", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/volta-4operacoes.png" },
        ...
        { id: "girafa", titulo: "Primos ou compostos - girafa", categoria: "Números primos ou compostos", descricao: "Números primos ou compostos", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/girafa.png" },
        ...
        { id: "roma", titulo: "Números romanos - Roma", categoria: "Números romanos", descricao: "Números romanos", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/roma.png" },
        { id: "escola-perimetro", titulo: "Perímetro - escola", categoria: "Perímetro", descricao: "Perímetro", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/escola-perimetro.png" },
        ...
        { id: "carnaval-porcentagem", titulo: "Porcentagem - carnaval", categoria: "Porcentagem", descricao: "Porcentagem", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/carnaval-porcentagem.png" },
        ...
        { id: "paises", titulo: "Potência e raiz - países", categoria: "Potenciação", descricao: "Potenciação", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/paises.png" },
        { id: "times", titulo: "Potência - times", categoria: "Potenciação", descricao: "Potenciação", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/times.png" },
        ...
        { id: "simpsons", titulo: "Potência - Simpsons", categoria: "Potenciação", descricao: "Potenciação", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/simpsons.png" },
        ...
        { id: "trilha-gatinho-radiacao", titulo: "Potência e raiz - gatinho", categoria: "Radiação", descricao: "Radiação", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/trilha-gatinho-radiacao.png" },
        { id: "Scooby-doo-radiacao", titulo: "Potência - Scooby Doo", categoria: "Radiação", descricao: "Radiação", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/Scooby-doo-radiacao.png" },
        { id: "simpsons-regra-de-tres", titulo: "Regra de três - Simpsons", categoria: "Regra de três", descricao: "Regra de três", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/simpsons-regra-de-tres.png" },
        { id: "sondagem-6ano", titulo: "Sondagem - 6º ano", categoria: "Volta às aulas", descricao: "Volta às aulas", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/sondagem.png" },
        { id: "sondagem-7ano", titulo: "Sondagem - 7º ano", categoria: "Volta às aulas", descricao: "Volta às aulas", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/sondagem.png" },
        { id: "sondagem-8ano", titulo: "Sondagem - 8º ano", categoria: "Volta às aulas", descricao: "Volta às aulas", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/sondagem.png" },
        { id: "sondagem-9ano", titulo: "Sondagem - 9º ano", categoria: "Volta às aulas", descricao: "Volta às aulas", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/sondagem.png" },
        { id: "volta-subtracao", titulo: "Subtração", categoria: "Volta às aulas", descricao: "Volta às aulas", preco: "R$ 5,50", imagem: "imagens/produtos/produto4.jpg", amostra: "imagens/amostras/sondagem.png" },
    ];
    ...
    if (filtrosContainer) {
        ...
        categorias.forEach(cat => {
            filtrosContainer.innerHTML += `
                <button class="btn-filtro" data-categoria="${cat}">
                    ${cat}
                </button>
            `;
        });
        ...
        filtrosContainer.addEventListener("click", (e) => {
            ...
            document.querySelectorAll(".produto-card").forEach(card => {
                ...
                const produto = produtosData.find(p => p.titulo === titulo);
